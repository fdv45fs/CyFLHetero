...
def receive_hetero_data():
    ...
    try:
        ...
        if not valid_metapath:
            logging.error(f"Metapath {metapath_tuples} is not valid for the current graph structure")
...
def cluster_nodes():
    ...
    try:
        ...
        # Tạo mapping node_name -> cluster_id
        node_to_cluster = {}
        label_index = 0
...
def predict_links():
    ...
    try:
        ...
        # Dự đoán liên kết bằng dot product
