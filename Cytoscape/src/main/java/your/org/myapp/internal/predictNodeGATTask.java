...
public class predictNodeGATTask extends AbstractTask {
    private static final String SERVER_URL = "http://localhost:5000/predict_node_label_GAT";
    private final CyApplicationManager applicationManager;

    public predictNodeGATTask(CyApplicationManager applicationManager) {
    ...
    public void run(TaskMonitor monitor) throws Exception {
        ...
        for (CyNode node : nodeList) {
            ...
            if (isSelected != null && isSelected) {
                ...
                monitor.setStatusMessage("Predicting label for node using GAT: " + nodeName);
                ...
                try (CloseableHttpClient httpClient = HttpClients.createDefault()) {
                    ...
                    try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                        ...
                        output.append("GAT Prediction: ").append(responseBuilder.toString()).append("\n\n");
                    }
                } catch (Exception e) {
        ...
        JFrame frame = new JFrame("GAT Node Prediction Results");
        ...
        monitor.setStatusMessage("GAT prediction results displayed in window.");
    }
}
